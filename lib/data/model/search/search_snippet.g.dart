...
class _$SearchSnippetSerializer implements StructuredSerializer<SearchSnippet> {
  ...
  Iterable<Object> serialize(Serializers serializers, SearchSnippet object,
    ...
    final result = <Object>[
      'pulishedAt',
      serializers.serialize(object.pulishedAt,
  ...
  SearchSnippet deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'pulishedAt':
          result.pulishedAt = serializers.deserialize(value,
...
class _$SearchSnippet extends SearchSnippet {
  ...
  _$SearchSnippet._(
      ...
      : super._() {
    if (pulishedAt == null) {
      throw new BuiltValueNullFieldError('SearchSnippet', 'pulishedAt');
    }
    if (channelId == null) {
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc($jc($jc(0, pulishedAt.hashCode), channelId.hashCode),
                    title.hashCode),
...
class SearchSnippetBuilder
  ...
  String _pulishedAt;
  String get pulishedAt => _$this._pulishedAt;
  set pulishedAt(String pulishedAt) => _$this._pulishedAt = pulishedAt;
